...
public final class CsdBloombergTafjLogger {
    ...
    public static Logger forClass(Class<?> owner) {
        ...
        synchronized (log) {
            ...
            try (InputStream in = CsdBloombergTafjLogger.class.getResourceAsStream(
                    "/sc-tafjlogging.properties")) {
                if (in != null) {
                    logProps.load(in);
                }
            } catch (IOException e) {
            ...
            final String logsPath = ((tafjHome != null && !tafjHome.trim().isEmpty()) ? tafjHome
                    : defaultFolder) + pathSuffix;
