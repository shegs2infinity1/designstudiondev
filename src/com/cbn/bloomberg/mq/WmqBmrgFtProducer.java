...
public class WmqBmrgFtProducer {
    ...
    public static void main(String[] args) {
        ...
        String mqHost = props.getProperty("mq.host", "172.105.249.157");
        ...
        String mqQueue = props.getProperty("ft.mq.inbound.queue", "FT.INBOUND.QUEUE");
        ...
        String rawDir = props.getProperty("ft.outbound.dir", "${bloomberg.base.dir}\\OUT\\FT");
        ...
        if (!Files.isDirectory(outwardDir)) {
            ...
            System.err.println("   You can configure this in " + PROPERTIES_FILE + " using property: ft.outbound.dir");
            return;
        }
    ...
    private static Properties loadProperties() {
        ...
        try {
            ...
            if (is == null) is = WmqBmrgFtProducer.class.getClassLoader().getResourceAsStream(PROPERTIES_FILE);
            if (is == null) is = WmqBmrgFtProducer.class.getResourceAsStream("/" + PROPERTIES_FILE);
            if (is == null) {
