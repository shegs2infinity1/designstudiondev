 ...
 */
public final class CbnFtMapper {

    private static final Logger LOGGER = Logger.getLogger(CbnFtMapper.class.getName());
    ...
    public static Map<String, String> mapFundsMovementToFt(JsonNode p_fm) {
        LOGGER.log(Level.INFO, "[CbnFtMapper] Starting mapping of JSON message");
