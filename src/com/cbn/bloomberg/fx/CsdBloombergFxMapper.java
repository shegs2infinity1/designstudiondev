...
public final class CsdBloombergFxMapper {
    ...
    private static final Logger yLogger = Logger.getLogger(CsdBloombergFxMapper.class.getName());
            ...
            switch (normalizedDealType) {
                case "SD": // Bskd deal
                    ...
                    yLogger.log(Level.FINE,
                            "[CsdBloombergFxMapper] SW: mapped swap-specific fields");
                    break;
                ...
                case "FW": // Forward deal
                    ...
                    yLogger.log(Level.FINE, "[CsdBloombergFxMapper] FW: mapped FORWARD_RATE={0}",
                            fwdRate);
                    break;
                ...
                case "SP":
                    ...
                    yLogger.log(Level.FINE, "[CsdBloombergFxMapper] SP: no deal-specific fields");
                    break;

                default:
                    yLogger.log(Level.WARNING, "[CsdBloombergFxMapper] Unknown DEAL_TYPE: {0}",
                            dlTpe);
            }
        }
    ...
    public static String mapDealTypeToOfsVsn(String dealType) {
        ...
        CsdBloombergFxProperties config = CsdBloombergFxProperties.getInstance();
        String ofsVersion = config.getOfsVersionDealType(dealType);
