...
public class WmqBmrgRoProducer {
    ...
    public static void main(String[] args) {
        ...
        if (props == null) { 
            ...
            System.err.println("   Make sure the file is in your resources directory (src/resources or src/test/resources)");
            return;
        }

        // Extract MQ configuration
        String mqHost = props.getProperty("mq.host", "172.22.105.46");
        int mqPort = Integer.parseInt(props.getProperty("mq.port", "1414"));
        String mqChannel = props.getProperty("mq.channel", "DEV.APP.SVRCONN");
        String mqQmgr = props.getProperty("mq.qmgr", "QM_BLOOMBERG");
        String mqQueue = props.getProperty("ro.mq.inbound.queue", "RO.INBOUND.QUEUE");
        String mqUser = props.getProperty("mq.user", "");
        String mqPass = props.getProperty("mq.password", "");

        // Expand placeholders for outbound directory
        String rawDir = props.getProperty("ro.outbound.dir", "${bloomberg.base.dir}\\OUT\\RO");
        ...
        if (!Files.isDirectory(outwardDir)) {
            ...
            System.err.println("   You can configure this in " + PROPERTIES_FILE + " using property: ro.outbound.dir");
            return;
        }
    ...
    private static Properties loadProperties() {
        ...
        try {
            ...
            if (is == null) is = WmqBmrgRoProducer.class.getClassLoader().getResourceAsStream(PROPERTIES_FILE);
            if (is == null) is = WmqBmrgRoProducer.class.getResourceAsStream("/" + PROPERTIES_FILE);
            if (is == null) {
