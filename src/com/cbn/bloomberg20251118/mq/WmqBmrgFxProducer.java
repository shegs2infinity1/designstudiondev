...
public class WmqBmrgFxProducer {
    ...
    public static void main(String[] args) {
        ...
        if (props == null) {
            ...
            System.err.println("   Make sure the file is in your resources directory (src/main/resources or src/test/resources)");
            return;
        }
        ...
        String mqQueue = props.getProperty("fx.mq.inbound.queue", "FX.INBOUND.QUEUE");
        ...
        String rawDir = props.getProperty("fx.outbound.dir", "${bloomberg.base.dir}\\OUT\\FX");
        ...
        if (!Files.isDirectory(outwardDir)) {
            ...
            System.err.println("   You can configure this in " + PROPERTIES_FILE + " using property: fx.outbound.dir");
            return;
        }
    ...
    private static Properties loadProperties() {
        ...
        try {
            ...
            if (is == null) is = WmqBmrgFxProducer.class.getClassLoader().getResourceAsStream(PROPERTIES_FILE);
