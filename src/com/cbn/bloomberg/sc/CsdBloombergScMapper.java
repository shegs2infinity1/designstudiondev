 ...
 */
public final class CsdBloombergScMapper {

    private static final Logger LOGGER = Logger.getLogger(CsdBloombergScMapper.class.getName());
    ...
    public static Map<String, String> mapSecurityMasterToSc(JsonNode pFm) {
        LOGGER.log(Level.INFO, "[CsdBloombergScMapper] Starting mapping of JSON message");
