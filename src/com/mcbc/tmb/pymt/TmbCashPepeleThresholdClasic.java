...
/**
 * TODO: Document me!
 * TO COMPUTE THE TRANSACTION THRESHOLD OVERRIDE FOR PEPELE Classic 
 * EB.API > V.VAL.TT.PPLE.CLSC.THRESHOLD.TMB
 * @author shegs
 *
 */

public class TmbCashPepeleThresholdClasic extends RecordLifecycle {
    ...
    private static final String LOG_FILE_PATH = LOG_DIRECTORY + "/TTDebugPepele" + LocalDate.now() + ".log";
    ...
    public TValidationResponse validateRecord(String application, String recordId, TStructure currentRecord,
        ...
        String ttTxn = tellerRecord.getTransactionCode().toString();
        
        TellerTransactionRecord txnRec = new TellerTransactionRecord(dataAccess.getRecord("TELLER.TRANSACTION", ttTxn));
        
        String ccyMkt = txnRec.getCurrMkt1().toString();
        
        logger.info("Currency Market used is " + ccyMkt);
        
        String currencyMarket = ccyMkt;
...
//        localAmount = parseAmount(tellerRecord.getAmountLocal2().getValue());
        ...
        parameterId = "EXCHANGE.PEPELE.THRESHOLD";
