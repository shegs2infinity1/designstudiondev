 ...
 *
 */
public class BulkPaymentUpdFileStatusAuthorised extends RecordLifecycle {
     ...
     * record
     * 
     * @category EB.API - V.UPD.BULKFILESTATUS.AUTH.TMB
    ...
    public void postUpdateRequest(String application, String currentRecordId, TStructure currentRecord,
        ...
        bulkPayFileHdrTrlRec.setFileStatus("AUTHORISED");
