 ...
 */
public final class CsdBloombergPdMapper {

    private static final Logger LOGGER = Logger.getLogger(CsdBloombergPdMapper.class.getName());
    ...
    */
    public static Map<String, String> mapPlacementsToPd(JsonNode pFm) {
        LOGGER.log(Level.INFO, "[CsdBloombergPdMapper] Starting mapping of JSON message");
