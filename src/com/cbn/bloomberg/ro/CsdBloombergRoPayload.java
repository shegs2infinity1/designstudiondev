 ...
 * publishing.
 */
public class CsdBloombergRoPayload {

    private static final Logger LOGGER = Logger.getLogger(CsdBloombergRoPayload.class.getName());
    private static final DateTimeFormatter TIMESTAMP_FMT = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss");
    private final ObjectMapper objectMapper;
    public CsdBloombergRoPayload(ObjectMapper objectMapper) {
